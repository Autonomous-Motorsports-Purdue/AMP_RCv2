...
#define JOYSTICK_R_SW_Pin GPIO_PIN_1
#define JOYSTICK_R_SW_GPIO_Port GPIOF
#define JOYSTICK_R_SW_EXTI_IRQn EXTI1_IRQn
#define JOYSTICK_L_V_Pin GPIO_PIN_0
#define JOYSTICK_L_V_GPIO_Port GPIOA
#define JOYSTICK_L_H_Pin GPIO_PIN_1
#define JOYSTICK_L_H_GPIO_Port GPIOA
#define VCP_TX_Pin GPIO_PIN_2
#define VCP_TX_GPIO_Port GPIOA
#define BTN_RIGHT_Pin GPIO_PIN_3
#define BTN_RIGHT_GPIO_Port GPIOA
#define BTN_RIGHT_EXTI_IRQn EXTI3_IRQn
#define JOYSTICK_R_V_Pin GPIO_PIN_4
#define JOYSTICK_R_V_GPIO_Port GPIOA
#define JOYSTICK_R_H_Pin GPIO_PIN_5
#define JOYSTICK_R_H_GPIO_Port GPIOA
#define BTN_LEFT_Pin GPIO_PIN_0
#define BTN_LEFT_GPIO_Port GPIOB
#define BTN_LEFT_EXTI_IRQn EXTI0_IRQn
#define OLED_NSS_Pin GPIO_PIN_1
...
#define JOYSTICK_L_SW_Pin GPIO_PIN_9
#define JOYSTICK_L_SW_GPIO_Port GPIOA
#define JOYSTICK_L_SW_EXTI_IRQn EXTI9_5_IRQn
